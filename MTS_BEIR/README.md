...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **MTS_BEIR** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description : 'Plots the breakeven inflation rate (BEIR)across five different industrialized
European countries - U.K., Germany, France, Italy and Sweden.'
...
Datafile : 'deinf.csv, denom.csv, fr_inf.csv, fr_nom.csv, italy_inf.csv, italy_nom.csv,
sweden_inf.csv, sweden_nom.csv, ukspot_nom.csv, ukspot_real.csv'

Example : 'BEIR for five industrialized European countries - U.K., Germany, France, Italy and
Sweden.'
